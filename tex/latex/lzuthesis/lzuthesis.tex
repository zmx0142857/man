...
% 支持断行的英文标题 (用于封面)
%\def\entitleMultirow{Lanzhou University Thesis Template for Bachelor Degree\newline Lanzhou University Thesis Template for Bachelor Degree}
% 短标题 (用于页眉)
\shorttitle{兰大本科毕设模板}
% 作者中文名
\zhauthor{卓铭鑫、黄洋锐}
...
\begin{verbatim}
ctex        geometry    fancyhdr    enumitem    tocloft
amsmath     amssymb     mathrsfs    makecell
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.25\textwidth]{lzu.pdf}
	\caption{单张图片}
	\label{p1}
\end{figure}
